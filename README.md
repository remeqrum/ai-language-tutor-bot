...
- **🗣️ Free Chat (Режим добавления слов):** Любое отправленное слово переводится, добавляется в базу данных пользователя вместе с примером сложного предложения, а затем бот просит перевести похожую фразу для закрепления.
